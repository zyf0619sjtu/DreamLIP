...
class CLIP(nn.Module):
    ...
    def __init__(
        ...
        self.logit_scale_local = None #nn.Parameter(torch.ones([]) * init_logit_scale)
        ...
        if use_meta_noun:
            ...
            self.multi_classifier = GroupWiseLinear(self.num_class,
                                    text.output_dim,
                                    bias=True)
        else:
    ...
    def forward(
        ...
        #image_features, local_image_features = self.encode_image(image, normalize=True) if image is not None else None
        ...
        if self.output_dict:
            out_dict = {
                ...
                "logit_scale_local": logit_scale_local,
                "classess_embs": classess_embs
            }
