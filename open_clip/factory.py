...
def create_model(
        ...
        use_meta_noun: Optional[str] = None,
        **model_kwargs,
):
    ...
    if pretrained and pretrained.lower() == 'openai':
        ...
        model_cfg['use_meta_noun'] = use_meta_noun
...
def create_loss(args):
    ...
    return ClipLoss(
        ...
        world_size=args.world_size,
        use_horovod=args.horovod,
        use_noun_labels=args.meta_nouns,
        tag_mode=args.tag_mode,
        use_longcap=args.use_longcap,
        use_multipos_loss=args.use_multipos_loss,
        use_ot_loss=args.use_ot_loss,
        use_finegrained_loss=args.use_finegrained_loss,
        use_declip_loss=args.use_declip_loss,
        gamma=args.gamma,
        margin=args.margin,
        sgl_delta=args.sgl_delta,
        sgl_norm=args.sgl_norm,
        clip_lossweight=args.clip_lossweight,
        sgl_lossweight=args.sgl_lossweight
    )
