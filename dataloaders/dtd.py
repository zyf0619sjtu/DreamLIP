...
def get_loader_train(
    ...
    dataset_train = DTD(root, download=False, split='train', transform=transform)
    dataset_val = DTD(root, download=False, split='val', transform=transform)
...
def get_loader_test(
    ...
    dataset_test = DTD(root, download=False, split='test', transform=transform)
